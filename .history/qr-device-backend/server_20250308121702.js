...
app.post("/add-device", async (req, res) => {
    try {
        ...
        const qrCodeData = `mongodb+srv://affanpics:affanaffan@cluster0.jafgy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/devicesDB/device/${newDevice._id}`;
